...
Regardless of the tool stack in use, the citation commands should be the same, e.g., \cmd{\cite}\marg{key} and \cmd{\citeauthor}\marg{key} (this command won't work with babel).
